...
enWinner WhoWonTheRound(stRoundInfo RoundInfo)
{
	...
	case enGameChoice::Paper:
		if (RoundInfo.ComputerChoice == enGameChoice::ÚScissors)
		{
			return enWinner::Computer;
		} break; case enGameChoice::ÚScissors:
...
void PrintRoundResults(stRoundInfo RoundInfo)
{
	...
	cout << " Player 1 Choise : " << RoundInfo.Player1Choice << endl;
	cout << " Computer Choise : " << RoundInfo.ComputerChoice << endl;
